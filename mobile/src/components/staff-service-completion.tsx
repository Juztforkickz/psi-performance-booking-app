...
const styles = StyleSheet.create({
  ...
  launchCopy: { color: colors.cream, fontSize: 12, lineHeight: 18 },
  ...
  vehicle: { color: colors.gold, fontSize: 12, fontWeight: '800', marginTop: -spacing.sm },
  warning: { color: colors.cream, fontSize: 11, lineHeight: 17 },
  notes: { minHeight: 104 },
