...
const st = StyleSheet.create({
  ...
  chipSelected: { backgroundColor: '#103340', borderColor: colors.accent },
  ...
  cardRow: { gap: 10 },
  card: { flexGrow: 0, flexShrink: 1, borderWidth: 1, borderColor: colors.line, borderRadius: 8, overflow: 'hidden', backgroundColor: '#101010' },
  cardSelected: { borderColor: colors.accent, backgroundColor: '#0D2028' },
