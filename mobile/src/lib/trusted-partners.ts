...
const PARTNERS: readonly TrustedPartner[] = [
  ...
  {
    id: 'bnb-autohaus',
    category: 'Luxury Interiors & Customisation',
    businessName: 'BNB Autohaus',
    summary: 'Luxury automotive interior transformations, upholstery, lighting and audio customisation.',
    address: 'Factory 1/61 Frankston Gardens Drive, Carrum Downs VIC 3201',
    phoneDisplay: '0432 029 355',
    phoneUrl: 'tel:+61432029355',
    email: 'sales@bnbautohaus.com.au',
    emailUrl: 'mailto:sales@bnbautohaus.com.au',
    websiteUrl: 'https://www.bnbleather.com/',
    instagramUrl: 'https://www.instagram.com/bnbautohaus/',
  },
  {
    id: 'elite-detailing',
