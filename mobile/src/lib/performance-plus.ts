...
type VaultDatabase = { public: { Tables: {
  ...
  vault_import_queue: Table<{ id: string; source: string; source_key: string; status: string; identifiers: Record<string, unknown>; job_id: string | null; reason: string; created_at: string }>;
