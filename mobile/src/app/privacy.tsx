...
const SECTIONS = [
  ...
  },
  {
    ...
    copy: 'PSI may publish private invoice PDFs, workshop photographs, documents and vehicle history linked to your account, vehicle and workshop job. When you create and complete your own verified PSI customer account, PSI may start one complimentary 14-day Performance+ trial. A workshop job prepared before sign-up can connect automatically when the registration matches and either the verified email matches or the full name and mobile match. Creating the workshop-only folder does not start the trial. The trial does not charge or renew. After it ends, premium contents lock but remain stored; PSI Free accounts can still see their own record counts. When store purchases are enabled, Apple or Google Play processes the purchase and RevenueCat verifies subscription transactions linked to your PSI account identifier. Workshop photographs and PDFs are not sent to RevenueCat. These providers may process subscription data outside Australia.',
  },
  {
