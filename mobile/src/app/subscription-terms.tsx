...
export default function SubscriptionTerms() {
  ...
  return <SafeAreaView style={s.screen}><ScrollView contentContainerStyle={s.content}>
    ...
    <Text style={s.copy}>PSI may provide one complimentary 14-day Performance+ trial when it publishes the first workshop photo gallery to your profile. The trial does not require payment, does not renew and does not automatically start a paid subscription. When it ends, your account returns to PSI Free and premium photos and records become locked but remain stored. Purchasing Performance+ unlocks the existing archive again.</Text>
