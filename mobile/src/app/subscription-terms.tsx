...
export default function SubscriptionTerms() {
  ...
  return <SafeAreaView style={s.screen}><ScrollView contentContainerStyle={s.content}>
    ...
    <Text style={s.copy}>PSI may provide one complimentary 14-day Performance+ trial when you create and complete your own verified PSI customer account. The trial does not require payment, does not renew and does not automatically start a paid subscription. When your verified email matches a workshop record prepared by PSI, that record can connect to your account automatically. When the trial ends, your account returns to PSI Free and premium photos and records become locked but remain stored. Purchasing Performance+ unlocks the existing archive again.</Text>
