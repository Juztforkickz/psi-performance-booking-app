...
export default function SubscriptionTerms() {
  ...
  return <SafeAreaView style={s.screen}><ScrollView contentContainerStyle={s.content}>
    ...
    <Text style={s.copy}>PSI Performance+ provides in-app access to workshop photos, invoice and receipt copies, dyno files, supporting documents, downloads and the organised vehicle archive. Available files vary by vehicle and workshop work completed. Your PSI Free profile, garage, vehicle photo, enquiries, booking options, service dates and summaries, recommendations, reminders and notifications remain available without a subscription. Xero invoices continue to be delivered by email. A subscription does not include physical workshop services, parts or unlimited file uploads.</Text>
