...
const styles = StyleSheet.create({
  ...
  vehicleChoiceMetaSelected: { color: colors.onSilverMuted },
  ...
  exampleImageLabelText: { color: '#DBE3E7', fontSize: 8, fontWeight: '900', letterSpacing: .5, textAlign: 'center', textTransform: 'uppercase' },
