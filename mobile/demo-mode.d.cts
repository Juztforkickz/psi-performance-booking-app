...
export const ANDROID_INTERNAL_CHANNEL: string;
export const ANDROID_INTERNAL_RUNTIME: string;
export const ANDROID_PLAY_INTERNAL_CHANNEL: string;
export const ANDROID_PLAY_INTERNAL_RUNTIME: string;
