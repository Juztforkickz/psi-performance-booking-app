...
- [Owner Settings refinement](https://expo.dev/accounts/psi-performance/projects/matt-psi/updates/931a90ab-c21d-40a1-bd12-b2abac84eed1) — commit `51100f6`, exact runtime `1.0.0-beta-performance-plus-1`; hides the redundant permanent-access plan panel only for permanent complimentary accounts.
- [Trusted Partners update](https://expo.dev/accounts/psi-performance/projects/matt-psi/updates/ab9002ca-0a93-48e1-a0a7-5045ba90b9ac) — commit `6ddf18c`, exact runtime `1.0.0-beta-performance-plus-1`; adds TRB Visuals Photography and Martini Racing Products with compact contact cards and bundled logos.
- [Fab Car Audio update](https://expo.dev/accounts/psi-performance/projects/matt-psi/updates/8e025f62-39f5-4e5a-a2c8-c95a3e35b127) — commit `618dcd1`, exact runtime `1.0.0-beta-performance-plus-1`; completes the three approved partner additions and brings the directory to ten businesses.
