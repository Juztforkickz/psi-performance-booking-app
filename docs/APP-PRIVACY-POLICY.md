...
applies in addition to the separate website and online-store privacy policy at
psiperformance.com.au.

### 2. Our privacy commitments

PSI uses personal information to provide customer accounts, workshop services,
vehicle records, booking communications and related support. We do not sell App
...
authenticator secrets or unnecessary information about another person.
...
workshop records or provide the requested feature. Optional photographs,
attachments, weather information and device notifications can be left unused.
...
address book or precise device location.

You can change camera, photo and notification permissions in the device
settings. You can also disable PSI device alerts and individual notification
categories within the App. Disabling a permission may prevent the relevant
optional feature from working but does not prevent ordinary customer support.

### 7. Workshop weather

The App may display current and forecast weather for the PSI workshop in
Pakenham. It sends the workshop's fixed coordinates, not the customer's device
location, to the weather provider. The provider may receive ordinary technical
request information such as an IP address and request time for service
operation, security and abuse prevention.

Weather information is indicative only and may be delayed or inaccurate. It
does not confirm workshop availability or a booking date.
...
to a Trusted Partner merely because a customer opens one of those links. The
third party's own privacy terms apply after the customer leaves the App.
...
and takes reasonable steps to require appropriate handling. Internet services
may route or process information in additional countries used by a provider or
its subprocessors. Contact PSI if you would like more information about current
provider arrangements.

### 10. Security

PSI uses safeguards appropriate to the nature of the information, including
passwordless email-code authentication, operating-system protected native
session storage, customer-ownership controls, private file storage, limited
staff access, authenticator MFA for workshop-wide access, encrypted network
connections, audit records and server-only provider credentials.

No online system can guarantee absolute security. Customers should protect
their email account and device, use only the newest PSI sign-in code, and never
share a sign-in code or authenticator secret. Suspected unauthorised access or
privacy incidents should be reported promptly to info@psiperformance.com.au.

### 11. Retention

PSI retains personal information only for as long as it is reasonably needed
...
### 12. Access, correction and export

You can review and correct editable profile and vehicle information after
secure sign-in. PSI-authored workshop records remain read-only in the App to
protect the integrity of service history, but you may ask PSI to investigate
and correct inaccurate personal information.

You may contact PSI to request access to, correction of or an export of the
personal information PSI holds about you. PSI may need to verify your identity
before acting and will not ask you to provide a password, sign-in code or
authenticator secret. PSI aims to respond within 30 calendar days. Access will
ordinarily be provided without charge, although PSI will tell you in advance if
a permitted reasonable administrative charge applies.

Some requests may be refused or limited where permitted by law, including to
protect another person's privacy, commercially sensitive evaluative material,
legal privilege or security. If a request is refused, PSI will explain the
reason where required and the available complaint options.

### 13. Account deletion

Signed-in customers can request account deletion from Account in the App. A
pending request can be cancelled until PSI begins processing it. A customer who
cannot access the App can use PSI's public account-deletion page or contact PSI
from the account email address.

PSI verifies deletion requests and normally completes them within 30 days.
Completion removes App login access, the customer profile, customer vehicles,
notification registrations and customer-uploaded files, together with other
associated App records that PSI is not legally required to keep.

Where PSI must retain a minimum workshop, invoice, taxation, warranty, safety,
security or dispute record, that information will be restricted, protected and
de-identified where appropriate. PSI will confirm when the account-deletion
process is complete. Deleting an App account does not cancel or remove rights
or remedies under the Australian Consumer Law.

### 14. Privacy complaints

To make a privacy complaint, email info@psiperformance.com.au with your name,
contact details, a description of the concern and the outcome you are seeking.
Do not include a password, sign-in code or authenticator secret.

PSI will acknowledge the complaint, may ask for information needed to verify
identity or investigate the issue, and aims to provide a response within 30
calendar days. If additional time is reasonably required, PSI will explain why
and provide an updated timeframe.

If you are not satisfied with PSI's response and the Privacy Act 1988 (Cth)
applies to the matter, you may contact the **Office of the Australian
Information Commissioner** at oaic.gov.au or by calling 1300 363 992. Other
consumer, contractual and legal rights may also apply.

### 15. Children

The App is intended for PSI customers managing vehicles and workshop services
and is not directed to children under 16. If PSI becomes aware that a child has
provided personal information without appropriate authority, PSI will review
and remove it where required.

### 16. Data incidents

PSI investigates suspected loss, unauthorised access or unauthorised disclosure
of personal information. Where the Notifiable Data Breaches scheme or another
law applies, PSI will assess the incident and notify affected people and the
relevant regulator when required.

### 17. Changes to this policy

PSI may update this policy when the App, service providers or legal obligations
change. The current version and its effective date will be published on PSI's
